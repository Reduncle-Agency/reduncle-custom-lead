...
export default function AdminPanel() {
  ...
  const logoGidInputRef = useRef(null);
  ...
  const removeLogo = () => {
    ...
    if (logoGidInputRef.current) logoGidInputRef.current.value = '';
  };
  ...
  const handleSubmit = async (e) => {
    ...
    setResult({ type: 'processing', message: '⏳ Generando página... (puede tardar 5-15 min)' });
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              rows="12"
              required
              placeholder="Escribe aquí todo el prompt con la información del cliente..."
              value={prompt}
